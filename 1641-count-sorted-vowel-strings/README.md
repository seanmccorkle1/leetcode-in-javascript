...
Note that "<em class="Highlight" match="ea" loopnumber="57895198" style="padding: 1px; box-shadow: rgb(229, 229, 229) 1px 1px; border-radius: 3px; -webkit-print-color-adjust: exact; background-color: rgb(255, 140, 0); font-style: inherit;">ea</em>" is not a valid string since 'e' comes after 'a' in the alphabet.
</pre>
