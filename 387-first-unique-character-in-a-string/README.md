...
<pre><strong>Input:</strong> s = "<em class="Highlight" match="leetcode*" loopnumber="199257086" style="padding: 1px; box-shadow: rgb(229, 229, 229) 1px 1px; border-radius: 3px; -webkit-print-color-adjust: exact; background-color: rgb(255, 255, 102); font-style: inherit;">leetcode</em>"
