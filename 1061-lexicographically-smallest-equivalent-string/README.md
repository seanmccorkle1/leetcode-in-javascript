...
<pre><strong>Input:</strong> s1 = "<em class="Highlight" match="leetcode" loopnumber="154981105" style="padding: 1px; box-shadow: rgb(229, 229, 229) 1px 1px; border-radius: 3px; -webkit-print-color-adjust: exact; background-color: rgb(255, 215, 0); color: rgb(255, 140, 0); font-style: inherit;">leetcode</em>", s2 = "programs", baseStr = "sourcecode"
